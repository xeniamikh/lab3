...
namespace HelloWorldTests
{
    public class TodoTaskTests
    {
        ...
        public void AddTaskTest()
        {
            ...
            var task1 = new TodoTask { Title = "Task 1", Description = "Description 1", Deadline = DateTime.Today.AddDays(4), IsCompleted = false};
            var task2 = new TodoTask { Title = "Task 2", Description = "Description 2", Deadline = DateTime.Today.AddDays(3), IsCompleted = false};
        ...
        public void DelTaskTest()
        {
            ...
            var task1 = new TodoTask { Title = "Task 1", Description = "Description 1", Deadline = DateTime.Today.AddDays(4), IsCompleted = false };
            var task2 = new TodoTask { Title = "Task 2", Description = "Description 2", Deadline = DateTime.Today.AddDays(3), IsCompleted = false };
            var task3 = new TodoTask { Title = "Task 3", Description = "Description 3", Deadline = DateTime.Today.AddDays(3), IsCompleted = false };
        ...
        public void CompletedTasksTest()
        {
            TodoList todoList = new TodoList();
            var task1 = new TodoTask { Title = "Task 1", Description = "Description 1", Deadline = DateTime.Today.AddDays(4), IsCompleted = false };
            var task2 = new TodoTask { Title = "Task 2", Description = "Description 2", Deadline = DateTime.Today.AddDays(4), IsCompleted = false };
